...
func TestLogFormatRoundTrip(t *testing.T) {
	messages := []Message{
		{Timestamp: refTime, Type: MsgChat, Sender: "alice", Content: "hello world"},
		{Timestamp: refTime, Type: MsgJoin, Sender: "bob"},
		{Timestamp: refTime, Type: MsgLeave, Sender: "bob", Extra: "voluntary"},
		{Timestamp: refTime, Type: MsgLeave, Sender: "bob", Extra: "kicked"},
		{Timestamp: refTime, Type: MsgNameChange, Sender: "NewName", Extra: "OldName"},
		{Timestamp: refTime, Type: MsgAnnouncement, Content: "maintenance soon", Extra: "Server"},
		{Timestamp: refTime, Type: MsgModeration, Sender: "alice", Content: "kicked", Extra: "bob"},
		{Timestamp: refTime, Type: MsgModeration, Sender: "alice", Content: "muted", Extra: "Server"},
...
func TestLogLineDistinct(t *testing.T) {
	...
	for _, mt := range types {
		msg := Message{Timestamp: refTime, Type: mt, Sender: "a", Content: "b", Extra: "c"}
